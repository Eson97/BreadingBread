 ...
 *   https://datatables.net/download/#bs/dt-1.13.2/b-2.3.4/b-html5-2.3.4/fc-4.2.1/fh-3.3.1/r-2.4.0/sl-1.6.0
 *
 * Included libraries:
 *   DataTables 1.13.2, Buttons 2.3.4, HTML5 export 2.3.4, FixedColumns 4.2.1, FixedHeader 3.3.1, Responsive 2.4.0, Select 1.6.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.13.2/b-2.3.4/b-html5-2.3.4/fc-4.2.1/fh-3.3.1/r-2.4.0/sl-1.6.0",
