using BreadingBread.Application;
...
using BreadingBread.WebUi.Common;
using BreadingBread.WebUi.Helpers;
    ...
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
               ...
               .AddNewtonsoftJson()
               .AddFluentValidation(fv => fv.RegisterValidatorsFromAssemblyContaining<IBreadingBreadDbContext>());

            services.AddHealthChecks()
                .AddDbContextCheck<BreadingBreadDbContext>();
            ...
            {
                document.Title = "BreadingBread API";
