...
using static BreadingBread.Application.UseCases.Reportes.Commands.AgregarReporte.AgregarReporteCommand;
using static BreadingBread.Application.UseCases.Reportes.Commands.AgregarReporte.AgregarReporteCommand.ReporteDTO;
...
namespace BreadingBread.Application.UseCases.Reportes.Commands.AgregarReporte
{
    public class AgregarReporteHandler : IRequestHandler<AgregarReporteCommand, AgregarReporteResponse>
    {
        ...
        public AgregarReporteHandler(IBreadingBreadDbContext db)
        {
            this.db = db;
        }
