...
namespace BreadingBread.Persistence
{
    public class BreadingBreadDbInitializer
    {
        ...
        private void SeedEnfermedad(BreadingBreadDbContext context)
        {
        ...
        private void SeedEtapaFenologica(BreadingBreadDbContext context)
        {
        ...
        private void SeedPlaga(BreadingBreadDbContext context)
        {
        ...
        private void SeedArchivoUsuario(BreadingBreadDbContext context)
        {
        ...
        private void SeedReporte(BreadingBreadDbContext context)
        {
